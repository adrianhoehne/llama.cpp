...
export interface ApiMoeLayerPerfTimingFields {
	...
	hot0_slots_total?: number;
	hot1_slots_total?: number;
	hot2_slots_total?: number;
	hot0_slots_per_call?: number;
	hot1_slots_per_call?: number;
	hot2_slots_per_call?: number;
	hot0_branch_time_per_call_us?: number;
	hot1_branch_time_per_call_us?: number;
	hot2_branch_time_per_call_us?: number;
	hot0_expert_matmul_time_per_call_us?: number;
	hot1_expert_matmul_time_per_call_us?: number;
	hot2_expert_matmul_time_per_call_us?: number;
	hot0_gather_scatter_time_per_call_us?: number;
	hot1_gather_scatter_time_per_call_us?: number;
	hot2_gather_scatter_time_per_call_us?: number;
