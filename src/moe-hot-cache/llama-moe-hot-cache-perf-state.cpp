...
void llama_moe_layer_perf_state::reset_locked(bool count_overflow) {
    for (auto & layer : layers) {
        ...
        layer.pp_dense_total_time_us = 0;
        layer.pp_dense_routing_time_us = 0;
        layer.pp_dense_worklist_time_us = 0;
        layer.pp_dense_hot_prepare_time_us = 0;
        layer.pp_dense_hot_ffn_time_us = 0;
        layer.pp_dense_cold_prepare_time_us = 0;
        layer.pp_dense_cold_ffn_time_us = 0;
        layer.pp_dense_merge_time_us = 0;
        layer.pp_dense_hot_gate_time_us = 0;
        layer.pp_dense_hot_up_time_us = 0;
        layer.pp_dense_hot_gate_up_time_us = 0;
        layer.pp_dense_hot_down_time_us = 0;
        layer.pp_dense_hot_activation_time_us = 0;
        layer.pp_dense_cold_gate_time_us = 0;
        layer.pp_dense_cold_up_time_us = 0;
        layer.pp_dense_cold_gate_up_time_us = 0;
        layer.pp_dense_cold_down_time_us = 0;
        layer.pp_dense_cold_activation_time_us = 0;
        ...
        layer.gate_up_time_us = 0;
        layer.gate_time_us = 0;
        layer.up_time_us = 0;
        layer.down_time_us = 0;
        layer.activation_time_us = 0;
