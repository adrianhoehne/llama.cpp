...
LLAMA_API void llama_moe_layer_perf_set_initial_mode(bool no_perf);
LLAMA_API void llama_moe_layer_perf_set_mode(llama_moe_layer_perf_mode mode);
LLAMA_API bool llama_moe_layer_perf_parse_mode(const char * value, llama_moe_layer_perf_mode & mode);
LLAMA_API const char * llama_moe_layer_perf_mode_name(llama_moe_layer_perf_mode mode);
...
LLAMA_API void llama_moe_layer_perf_reset();
LLAMA_API bool llama_moe_layer_perf_has_data();
